...
const allUpperCase = (arr) => {
  ...
  let newArray2 = [];
  arr.forEach(value2 => {
 let newValue2 = value2.toUpperCase();
 newArray2.push(newValue2);
  })
...
const speaker = (words, callback) => {
  // Solution code here...
  let newArray3 = [];
  words.forEach(value3 => {
    let newValue3 = callback(value3);
    newArray3.push(newValue3);
  })
  return newArray3;
};
